...
var f = (function (){var pred__27202 = cljs.core._EQ_;
var expr__27203 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27202.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27203))){
return ((function (pred__27202,expr__27203){
return (function (p1__27196_SHARP_){
return console.warn(p1__27196_SHARP_);
});
;})(pred__27202,expr__27203))
} else {
if(cljs.core.truth_(pred__27202.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27203))){
return ((function (pred__27202,expr__27203){
...
if(cljs.core.truth_(pred__27202.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27203))){
return ((function (pred__27202,expr__27203){
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27206){
...
var eval_fn = cljs.core.get.call(null,map__27207__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27209_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__27211,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1613265451369
